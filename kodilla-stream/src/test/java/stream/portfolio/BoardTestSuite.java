...
//
//        //When
//        double tasksCount = project.getTaskLists().stream()
//                .filter(f -> f.getName().equals("In progress"))
//                .flatMap(f -> f.getTasks().stream())
//                .mapToInt(f -> (int) DAYS.between(f.getCreated(), LocalDate.now()))
//                .average().getAsDouble();
//
//        //Then
//        assertEquals(tasksCount, 10);
//
//    }
//
//}
